  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          data = _context.sent;
          console.log("Show data fetched. Count: ".concat(data.pagination.perPage));
          return _context.abrupt("return", {
            posts: data.data.map(function (entry) {
              return entry.posts;
            })
          });
...
//# sourceMappingURL=index.js.44f9eb286158cdf365a4.hot-update.js.map