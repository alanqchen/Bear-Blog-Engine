...
import { HeaderLink } from "../PublicNavBar/NavBarStyledBase";
    ...
    <div>
      <List>
        ...
        <ListItem
          button
          onClick={() => {
            pushLink("/auth/portal/dashboard");
          }}
          selected={selectedCategory === "Posts" ? true : false}
        >
          <ListItemIcon>
            <ListIcon />
          </ListItemIcon>
        ...
        <ListItem
          button
          onClick={() => {
            pushLink("/auth/portal/dashboard/editors");
          }}
          selected={selectedCategory === "Editors" ? true : false}
        >
          <ListItemIcon>
            <EditorsIcon />
          </ListItemIcon>
