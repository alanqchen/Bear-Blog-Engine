    ...
    return (
      <html lang="en">
        <Head>
          ...
          <meta name='twitter:image' content={config.blogURL + '/static/icons/android/android-launchericon-192-192.png'} />
          ...
          <meta property='og:image' content={config.blogURL + '/static/icons/apple-touch-icon.png'} />
        </Head>
